...
public static String home = ""+System.getProperty("user.home")+"";
	...
	public void setTray() {
		if (SystemTray.isSupported()) {
			...
			Image icon = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir()+ "/Sprites/Cursors/icon.png");
			trayIcon = new TrayIcon(icon, "Diviantion of Gods");
			trayIcon.setImageAutoSize(true);
			try {
				SystemTray tray = SystemTray.getSystemTray();
				tray.add(trayIcon);
				trayIcon.displayMessage("Divination of Gods V1", "Divination has been launched!", TrayIcon.MessageType.INFO);
	...
	//if(Desktop.getDesktop().isSupported(Action.OPEN)) {
		...
		Desktop.getDesktop().open(new File(""+home+"/InsanityCacheV5/Scre/"));
	//}
}
				}
			...
			if (cmd.equalsIgnoreCase("Client Information")){
				JOptionPane.showMessageDialog(this, "Divination Ltd!", "Client Updates", JOptionPane.INFORMATION_MESSAGE); 
			}
...
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/standard1.png");
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/sword.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/wand.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/Godsword.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/Scimitar.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/Granite maul.png");
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/twohander.png");
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/Halberd.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/warspear.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/Longsword.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/guitar.png");
Point hotSpot = new Point(0,0);  
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/pikachu.png");
...
{
Toolkit toolkit = Toolkit.getDefaultToolkit();  
Image image = toolkit.getImage(signlink.findcachedir()+ "/Sprites/Cursors/kenny.png");
Point hotSpot = new Point(0,0);  
...
setCursor(cursor);
	 ...
	 public void takeScreenshot(boolean flag)
    {
        ...
        if(!flag)
        {
            ...
            fileChooser.setCurrentDirectory(new File(""+home+"/InsanityXCacheV1/Scre/"));
        ...
        } else
        {
            try
            {
                ImageIO.write(bufferedimage, "png", new File((new StringBuilder()).append(""+home+"/InsanityXCacheV1/Scre/").append(s).toString()));
					                             JOptionPane.showMessageDialog(frame, "Image has been saved to "+home+"/InsanityXCacheV1/Scre/. You can view your images by pushing File>View Images in the menu dropdowns." , "Screenshot manager", JOptionPane.INFORMATION_MESSAGE);
                //client.pushMessage("Screenshot taken.", 3, "@cr2@ Client");
                //JOptionPane.showMessageDialog(frame,"Screenshot taken.");
            }
...
class imageFileFilter extends FileFilter
{
	...
	public Jframe(String args[]) {
		...
		//	setTray();
			...
			String[] cursorsButtons = new String[]
				{
	...
	public void initUI() {
		try {
			...
			frame.setIconImage(Toolkit.getDefaultToolkit().getImage(signlink.findcachedir()+ "Cursors/Cursors/icon.png"));
