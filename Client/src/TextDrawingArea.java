...
// Source File Name:   TextDrawingArea.java
...
public final class TextDrawingArea extends DrawingArea
{
    ...
    public TextDrawingArea(boolean flag, String s, StreamLoader streamLoader)
    {
        try
        {
            int length = !s.equals("hit_full") && !s.equals("critical_full") ? 256 : 58;
    ...
    private void method395(byte abyte0[], int i, int j, int ai[], int l, int i1, int j1, 
