...
public final class Player extends Entity {
	...
	public void updatePlayer(Stream stream) {
		...
		for (int j = 0; j < 12; j++) {
			...
			if (equipment[j] >= 512)
				if (equipment[j] - 512 >= ItemDef.totalItems)
					;
		}
	...
	public Model method452() {
		...
		if (model_1 == null) {
			...
			model_1.method479(frontLight, backLight, rightLight, middleLight, leftLight, true);
			if (playerWidth != 128 || scalePlayerY != 128
					|| scalePlayerHeight != 128)
				model_1.method478(playerWidth, scalePlayerY, scalePlayerHeight);
	...
	public Model method453() {
		...
		for (int l = 0; l < 12; l++) {
			...
			if (i1 >= 256 && i1 < 512) {
				...
				model_1 = IDK.cache[i1 - 256].method540();
				if (model_1 != null)
	...
	public int scalePlayerY;
	public int scalePlayerHeight;
