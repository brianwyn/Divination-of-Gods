...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		//class46.hasActions = true;		if (class46.name != null)
			if (class46.name.equalsIgnoreCase("Door")) {
				...
				if (i == 2783) {
			class46.name = "Anvil";
			class46.itemActions[0] = "Smith";
		}		
		if (i == 7315) {
			class46.name = "Fun-Pk Portal";
			class46.itemActions[0] = "Use";
		}	
		if (i == 1151) {
			class46.name = "Fairy Stall";
			class46.itemActions[0] = "Steal-From";
		}
		if (i == 2732) {
		class46.itemActions[0] = "Add-logs";
		}	
		if (i == 13660) {
		class46.itemActions[0] = "Use";
		class46.itemActions[4] = "Remove";
		}		
		if (i == 27663) {
		class46.itemActions[4] = "Remove";
		}
		...
		if (i == 11220) {
			...
			class46.aBoolean769 = false;
				...
				if (i == 2282) {
			class46.name = "Ropeswing";
			class46.itemActions = new String[5];
			class46.itemActions[0] = "Swing-on";
			class46.hasActions = true;
		}
		if (i == 11212) {
			class46.name = "Teleporter";
			class46.description = "Allows you to teleport to places."
					.getBytes();
			class46.anInt744 = 1;
			class46.anInt761 = 1;
			class46.anIntArray773 = new int[1];
		...
		if (i == 11209) {
			...
			class46.description = "Allows you to create teleport tablets."
					.getBytes();
			class46.anInt744 = 1;
			class46.anInt761 = 1;
			class46.anIntArray773 = new int[1];
		...
		if (class46.modifiedModelColors == null) { // :)
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		...
		FileOperations.WriteFile("" + signlink.findcachedir() + "loc.dat",
				streamLoader.getDataForName("loc.dat"));
		FileOperations.WriteFile("" + signlink.findcachedir() + "loc.idx",
				streamLoader.getDataForName("loc.idx"));*/
		...
		label0: do {
			...
			do {
				...
				if (j == 1) {
					...
					aBoolean769 = false; // change to false to fix gowwars
											// waterfalls??
				else if (j == 23)
					aBoolean764 = true;
				else if (j == 24) {
