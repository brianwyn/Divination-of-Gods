...
// Source File Name:   TextClass.java
...
final class TextClass
{
    ...
    public static String nameForLong(long l)
    {
        ...
        {
            signlink.reporterror((new StringBuilder()).append("81570, ").append(l).append(", ").append(-99).append(", ").append(runtimeexception.toString()).toString());
        }
