...
public class BarbarianDefence {
	...
	private final int[][] COORDS = { { 1889, 5405 }, { 1887, 5405 },
			{ 1884, 5405 }, { 1884, 5407 }, { 1884, 5409 }, { 1886, 5410 },
			{ 1889, 5410 }, { 1889, 5408 }, { 1889, 5406 }, { 1887, 5406 },
			{ 1885, 5406 }, { 1887, 5409 } };
	...
	public void endGame(Client c, boolean victory) {
		...
		c.sendMessage(victory ? "Congratulations, you've completed all "
				+ WAVES.length + " waves of Barbarian Defense!" : "Game ended.");
		...
		System.out.println("Barbarian Assault Completed By: " + c.playerName
				+ "");
		c.getPA().movePlayer(1894, 5408, 0);
		c.inBarbDef = false;
	...
	public void enter(Client c) {
		...
		c.spawned1 = false;
		c.getPA().movePlayer(1886, 5407, c.playerId * 4);
		System.out
	...
	public void spawnWave(Client c) {
		if (c != null && c.inBarbDef) {
			...
			c.sendMessage("TYPE ::endgame TO END THE GAME. You will still receive any points that you've earned.");
			c.getPA().movePlayer(1887, 5407, c.playerId * 4);
			...
			if (c.spawned1 == false)
				Server.npcHandler.spawnNpc56(c, 751, 1885, 5409, c.heightLevel,
