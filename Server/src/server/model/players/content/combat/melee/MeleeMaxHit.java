...
public class MeleeMaxHit {
	...
	public static final double[][] special = { { 5698, 1.1 }, { 5680, 1.1 },
			...
			{ 20000, 1.375 }, { 20001, 1.375 }, { 20002, 1.375 },
			{ 20004, 1.375 }, { 11696, 1.21 }, { 11698, 1.10 },
			{ 11700, 1.10 }, { 861, 1.1 }, { 4151, 1.1 }, { 10887, 1.2933 }, };
	...
	public static int calculateMeleeAttack(Client c) {
		...
		if (c.prayerActive[2]) {
			...
			attackLevel += c.getLevelForXP(c.playerXP[Player.playerAttack])
					* 0.5 + c.getatt;
		}
		if (c.fullVoidMelee()) {
			attackLevel += c.getLevelForXP(c.playerXP[Player.playerAttack]) * 0.1;
	...
	public static boolean hasVoid(Client c) {
		return c.playerEquipment[Player.playerHat] == 11665
				&& c.playerEquipment[Player.playerLegs] == 8840
				&& c.playerEquipment[Player.playerChest] == 8839
				&& c.playerEquipment[Player.playerHands] == 8842;
	}
}