...
public class MeleeData {
	...
	public static int getAttackDelay(Client c, String s) {
		...
		if (c.fightMode == 2) { // Rapid
			if (c.playerEquipment[Player.playerWeapon] == 20403)
				return 3; // Drygore Rap
			if (c.playerEquipment[Player.playerWeapon] == 9185)
				return 7; // rune cbow
			if (c.playerEquipment[Player.playerWeapon] == 18357
					|| c.playerEquipment[Player.playerWeapon] == 15241)
				return 6;// chaotic cbow
			if (c.playerEquipment[Player.playerWeapon] == 861)
				return 4;// mage shortbow
			if (c.playerEquipment[Player.playerWeapon] == 18353) // cmaul
				return 7;// chaotic maul
		} else if (c.fightMode == 0) {
			if (c.playerEquipment[Player.playerWeapon] == 20403)
				return 3; // Drygore Rap
			if (c.playerEquipment[Player.playerWeapon] == 9185)
				return 8; // rune cbow
			if (c.playerEquipment[Player.playerWeapon] == 18357
					|| c.playerEquipment[Player.playerWeapon] == 15241)
				return 8;// chaotic cbow
			if (c.playerEquipment[Player.playerWeapon] == 18353) // cmaul
				return 8;// chaotic maul
		}

		if (c.playerEquipment[Player.playerWeapon] == 20000)
			return 4;// gs
		if (c.playerEquipment[Player.playerWeapon] == 20001)
			return 4;// gs
		if (c.playerEquipment[Player.playerWeapon] == 20002)
			return 4;// gs
		if (c.playerEquipment[Player.playerWeapon] == 20003)
			return 4;// gs
		if (c.playerEquipment[Player.playerWeapon] == 18349)
			return 5;// chaotic rapier
		if (c.playerEquipment[Player.playerWeapon] == 18353) // cmaul
			return 7;// chaotic maul
		if (c.playerEquipment[Player.playerWeapon] == 16877)
			return 4;// dung 16877 shortbow
		if (c.playerEquipment[Player.playerWeapon] == 19143)
			return 4;// sara shortbow
		if (c.playerEquipment[Player.playerWeapon] == 19146)
			return 4;// guthix shortbow
		if (c.playerEquipment[Player.playerWeapon] == 14990)
			return 6;// z bow
		if (c.playerEquipment[Player.playerWeapon] == 19149)
			return 4;// zammy shortbow
	...
	public static void getPlayerAnimIndex(Client c, String weaponName) {
		...
		if (weaponName.startsWith("bow-sword")) {
			c.playerStandIndex = 1765;
			c.playerWalkIndex = 1765;
			c.playerRunIndex = 1765;
			return;
		}
		...
		if (weaponName.contains("longsword") || weaponName.contains("scimitar")
		...
		if (weaponName.contains("wand") || weaponName.contains("staff")
				|| weaponName.contains("staff") || weaponName.contains("spear")) {
