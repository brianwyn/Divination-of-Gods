...
public class Cons {
	...
	/**
	 * @author Gabbe: gabbe_impactpk@live.com Made for Construction interface
	 *         buttons handling.
	 */

	public static int altarX = 2061; // Buildable altar
	public static int altarY = 3140; // Buildable Altar
	public static int TelePorterX = 2060; // the portal thing that makes you
											// able to teleport everywhere
	public static int TelePorterY = 3147; // the portal thing that makes you
											// able to teleport everywhere
	...
	public static void BuildAChair(final Client c) {
		if (c == null) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.getItems().playerHasItem(1539, 30)
						&& c.getItems().playerHasItem(2347, 1)
						&& c.getItems().playerHasItem(960, 3)) {
					c.startAnimation(898);
					c.getItems().deleteItem2(1539, 30);
					c.getItems().deleteItem2(960, 3);
					c.COChair += 5;
					c.getPA().closeAllWindows();
					c.getPA().addSkillXP(5000, 23);
					c.getPA().checkObjectSpawn(13581, 2058, 3147, 0, 10);
					container.stop();
				} else {
					c.sendMessage("You don't have the required materials.");
					c.sendMessage("You need 30 Steel Nails, 1 hammer and 3 planks.");
					container.stop();
				}
	...
	public static void BuildAltar(final Client c) {
		...
		if (c.playerLevel[23] < 65) {
			c.sendMessage("You need level 65 construction to build that!");
			return;
		}
		if (!c.getItems().playerHasItem(2347, 1)) {
			c.sendMessage("You need a hammer to build this!");
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 64) {
					if (c.getItems().playerHasItem(1539, 15)
							&& c.getItems().playerHasItem(8782, 1)
							&& c.getItems().playerHasItem(8782, 1)
						...
						c.getPA().closeAllWindows();
						c.getPA().addSkillXP(32000, 23);
						c.getPA().checkObjectSpawn(13191, altarX, altarY,
								c.heightLevel, 10);
						container.stop();
					} else {
						c.sendMessage("You don't have the required materials.");
	...
	public static void BuildBed(final Client c) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 40) {
					if (c.getItems().playerHasItem(1539, 20)
							&& c.getItems().playerHasItem(8778, 3)) {
						...
						c.getPA().checkObjectSpawn(13151, bedX, bedY,
								c.heightLevel, 10);
						container.stop();
					} else {
						c.sendMessage("You don't have the required materials.");
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 94) {
					if (c.getItems().playerHasItem(1539, 40)
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 67) {
					if (c.getItems().playerHasItem(1539, 80)
							&& c.getItems().playerHasItem(8007, 100)
							&& c.getItems().playerHasItem(8009, 100)
							&& c.getItems().playerHasItem(8010, 100)) {
						c.startAnimation(898);
						...
						c.getPA().checkObjectSpawn(13660, CrystalBallX,
								CrystalBallY, 0, 10);
						container.stop();
					} else {
						c.sendMessage("You don't have the required materials.");
						c.sendMessage("You need 80 Steel Nails, 1 hammer, 100 Varrock, Falador and Camelot teleport tabs.");
						container.stop();
					}
				}
				if (c.disconnected) {
	...
	public static void BuildLecterFuckersss(final Client c) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 67) {
					if (c.getItems().playerHasItem(1539, 54)
							&& c.getItems().playerHasItem(561, 27)
							&& c.getItems().playerHasItem(2351, 4)) {
						c.startAnimation(898);
						...
						c.getPA().closeAllWindows();
						c.getPA().addSkillXP(20000, 23);
						c.getPA().checkObjectSpawn(13648, Lect1X, Lect1Y,
								c.heightLevel, 10);
						c.getPA().checkObjectSpawn(13648, Lect2X, Lect2Y,
								c.heightLevel, 10);
						container.stop();
					} else {
						c.sendMessage("You don't have the required materials.");
	...
	public static void BuildTeleportFuckerrDerpHurrDurr(final Client c) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 67) {
					if (c.getItems().playerHasItem(1539, 300)
							&& c.getItems().playerHasItem(561, 100)
							&& c.getItems().playerHasItem(556, 100)
							&& c.getItems().playerHasItem(554, 100)
							&& c.getItems().playerHasItem(555, 100)
							&& c.getItems().playerHasItem(557, 100)) {
						c.startAnimation(898);
						...
						c.getPA().closeAllWindows();
						c.getPA().addSkillXP(1000, 23);
						c.getPA().checkObjectSpawn(13641, TelePorterX,
								TelePorterY, 0, 10);
						container.stop();
					} else {
						c.sendMessage("You don't have the required materials.");
	...
	public static void BuildTree(final Client c) {
		...
		if (c.playerLevel[23] < 20) {
			c.sendMessage("You need a level of 20 Construction to do that.");
			return;
		}
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			@Override
			public void execute(CycleEventContainer container) {
				...
				if (c.playerLevel[23] > 20) {
					if (c.getItems().playerHasItem(1511, 3)
							&& c.getItems().playerHasItem(5343, 1)) {
						c.startAnimation(2291);
						c.COtreee += 5;
						c.getItems().deleteItem2(1511, 3);
						c.sendMessage("You make a tree!");
						c.getPA().closeAllWindows();
						c.getPA().addSkillXP(10000, 23);
						c.getPA().checkObjectSpawn(13411, TreeX, TreeY,
								c.heightLevel, 10);
						container.stop();
					} else {
						c.sendMessage("You don't have the required materials.");
	...
	public static void HandleConstructionInterface(final Client c,
		...
		case 122034:// small oven
			...
			if (c.getItems().playerHasItem(2351, 3)) {
				...
				c.getPA().checkObjectSpawn(13533, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122037:// carved oak bench
			...
			if (c.getItems().playerHasItem(1539, 15)
				...
				c.getPA().checkObjectSpawn(13302, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122040:// painting stand
			...
			if (c.getItems().playerHasItem(1539, 20)
					&& c.getItems().playerHasItem(8778, 2)) {
				c.getItems().deleteItem2(1539, 20);
				...
				c.getPA().checkObjectSpawn(13717, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122043:// bed
			...
			if (c.getItems().playerHasItem(1539, 20)
				...
				c.getPA().closeAllWindows();
				c.getPA().addSkillXP(10000, 23);
				c.getPA().checkObjectSpawn(13151, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122046:// teak drawers
			...
			if (c.getItems().playerHasItem(1539, 20)
					&& c.getItems().playerHasItem(8780, 1)
					&& c.getItems().playerHasItem(8780, 1)) {
				c.getItems().deleteItem2(1539, 20);
				...
				c.getPA().checkObjectSpawn(13158, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122049:// mithril armour
			...
			if (c.getItems().playerHasItem(1159, 1)
					&& c.getItems().playerHasItem(1121, 1)
					&& c.getItems().playerHasItem(1071, 1)) {
				...
				c.getPA().checkObjectSpawn(13491, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122052:// adamant armour
			...
			if (c.getItems().playerHasItem(1161, 1)
					&& c.getItems().playerHasItem(1123, 1)
					&& c.getItems().playerHasItem(1073, 1)) {
				...
				c.getPA().addSkillXP(25 * Config.SMITHING_EXPERIENCE, 13);
				c.getPA().checkObjectSpawn(13492, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122055:// rune armour
			...
			if (c.getItems().playerHasItem(1163, 1)
					&& c.getItems().playerHasItem(1127, 1)
					&& c.getItems().playerHasItem(1079, 1)) {
				...
				c.getPA().addSkillXP(25 * Config.SMITHING_EXPERIENCE, 13);
				c.getPA().checkObjectSpawn(13493, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122058:// rune display case
			...
			if (c.getItems().playerHasItem(563, 100)
					&& c.getItems().playerHasItem(561, 100)
					&& c.getItems().playerHasItem(8780, 1)) {
				...
				c.getPA().checkObjectSpawn(13508, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122061:// archery target
			...
			if (c.getItems().playerHasItem(1539, 25)
					&& c.getItems().playerHasItem(8780, 3)) {
				...
				c.getPA().checkObjectSpawn(13402, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122064:// combat stone
			...
			if (c.getItems().playerHasItem(2351, 4)) {
				...
				c.getPA().checkObjectSpawn(-1, c.absX, c.absY, c.heightLevel,
						10);
				Server.npcHandler.spawnNpc(c, 4162, c.absX, c.absY,
						c.heightLevel, 0, 100, 5, 50, 50, false, true);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122067:// elemental balance
			...
			if (c.getItems().playerHasItem(2351, 5)
					&& c.getItems().playerHasItem(1539, 49)) {
				...
				c.getPA().checkObjectSpawn(-1, c.absX, c.absY, c.heightLevel,
						10);
				Server.npcHandler.spawnNpc(c, 4095, c.absX, c.absY,
						c.heightLevel, 0, 100, 5, 50, 50, false, true);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122070:// mahogany prize chest
			...
			if (c.getItems().playerHasItem(1539, 20)
					&& c.getItems().playerHasItem(8782, 4)) {
				c.getItems().deleteItem2(1539, 20);
				c.getItems().deleteItem2(8782, 4);
				c.sendMessage("You build a Mahogany prize chest.");
				c.getPA().closeAllWindows();
				c.getPA().addSkillXP(4000, 23);
				c.getPA().checkObjectSpawn(13389, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122073:// lectern
			...
			if (c.getItems().playerHasItem(555, 50)
					&& c.getItems().playerHasItem(560, 50)) {
				...
				c.getPA().checkObjectSpawn(13648, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122076:// crystal of power
			...
			if (c.getItems().playerHasItem(1539, 15)
					&& c.getItems().playerHasItem(565, 30)
					&& c.getItems().playerHasItem(8782, 2)
					&& c.getItems().playerHasItem(2351, 1)) {
				c.getItems().deleteItem2(1539, 15);
				c.getItems().deleteItem2(8782, 2);
				...
				c.getPA().checkObjectSpawn(13661, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122079:// altar
			...
			if (c.getItems().playerHasItem(1539, 55)
					&& c.getItems().playerHasItem(561, 100)
					&& c.getItems().playerHasItem(536, 3)
					&& c.getItems().playerHasItem(8782, 2)) {
				...
				c.getPA().checkObjectSpawn(13191, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122082:// intense burners
			...
			if (c.getItems().playerHasItem(1539, 27)
					&& c.getItems().playerHasItem(8782, 2)
					&& c.getItems().playerHasItem(564, 40)
					&& c.getItems().playerHasItem(263, 1)) {
				...
				c.getPA().closeAllWindows();
				c.getPA().addSkillXP(4000, 23);
				c.getPA().checkObjectSpawn(13210, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122085:// hedge
			...
			if (c.getItems().playerHasItem(1511, 2)
					&& c.getItems().playerHasItem(561, 11)
					&& c.getItems().playerHasItem(265, 2)) {
				...
				c.getPA().checkObjectSpawn(13476, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122088:// rocnar
			...
			if (c.getItems().playerHasItem(2361, 2)
					&& c.getItems().playerHasItem(269, 2)
					&& c.getItems().playerHasItem(562, 10)) {
				...
				c.getPA().closeAllWindows();
				c.getPA().addSkillXP(7000, 23);
				c.getPA().checkObjectSpawn(13373, c.absX, c.absY,
						c.heightLevel, 10);
			} else {
				c.sendMessage("You don't have the required materials.");
		...
		case 122091:// bank chest
			...
			if (c.getItems().playerHasItem(1539, 40)
				...
				c.getPA().checkObjectSpawn(3193, c.absX, c.absY, c.heightLevel,
						10);
			} else {
				c.sendMessage("You don't have the required materials.");
	...
	public static void spawnChairv1(final Client c) {
		if (c == null) {
			// c.sendMessage("You need to be in the construction skilling area first!");
			return;
		}
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.COChair > 3) {
					...
					if (c.COChair < 2) {
						c.getPA().checkObjectSpawn(11240, 2058, 3147, 0, 10);
						container.stop();
					}
				}
				if (c.disconnected) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				if (c.COcryst > 3) {
					...
					if (c.COcryst < 2) {
						c.getPA().checkObjectSpawn(11209, CrystalBallX,
								CrystalBallY, 0, 10);
						container.stop();
					}
				}
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				if (c.COaltar > 3) {
					...
					if (c.COaltar < 2) {
						c.getPA()
								.checkObjectSpawn(11215, altarX, altarY, 0, 10);
						container.stop();
					}
				}
				if (c.disconnected) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				if (c.COchest > 3) {
					...
					if (c.COchest < 2) {
						c.getPA()
								.checkObjectSpawn(11219, ChestX, ChestY, 0, 10);
						container.stop();
					}
				}
				if (c.disconnected) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				if (c.COLectt > 3) {
					...
					if (c.COLectt < 2) {
						c.getPA()
								.checkObjectSpawn(11220, Lect1X, Lect1Y, 0, 10);
						c.getPA()
								.checkObjectSpawn(11220, Lect2X, Lect2Y, 0, 10);
						container.stop();
					}
				}
				if (c.disconnected) {
	...
	public static void SpawnTeleporter(final Client c) {
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.COtelee > 3) {
					c.getPA().checkObjectSpawn(13641, TelePorterX, TelePorterY,
							0, 10);
					container.stop();
				} else {
					if (c.COtelee < 2) {
						c.getPA().checkObjectSpawn(11212, TelePorterX,
								TelePorterY, 0, 10);
						container.stop();
					}
				}
